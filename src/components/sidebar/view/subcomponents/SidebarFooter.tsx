...
export default function SidebarFooter({
  ...
  return (
    <div className="flex-shrink-0" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0)' }}>
      ...
      <div className="hidden px-3 pt-1 md:block">
        <a
          href={GITHUB_ISSUES_URL}
          target="_blank"
          rel="noopener noreferrer"
          className="flex w-full items-center gap-2 rounded-lg px-2.5 py-1.5 text-xs font-medium text-muted-foreground transition-all duration-200 hover:bg-zinc-200/50 dark:hover:bg-zinc-800/40 hover:text-foreground"
        >
      ...
      <div className="px-3 pt-3 md:hidden">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex h-12 w-full items-center gap-3.5 rounded-xl bg-zinc-100/50 dark:bg-zinc-900/30 border border-zinc-200/30 dark:border-zinc-800/30 px-4 transition-all hover:bg-zinc-200/40 dark:hover:bg-zinc-800/40 active:scale-[0.98]"
        >
          <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-white dark:bg-zinc-800 shadow-sm border border-zinc-200/10 dark:border-zinc-700/10">
            <Bug className="w-4.5 h-4.5 text-muted-foreground" />
          </div>
          <span className="text-sm font-semibold text-foreground">{t('actions.reportIssue')}</span>
        </a>
      </div>
      ...
      <div className="px-3 pt-2 md:hidden">
        ...
        >
          ...
          <span className="text-sm font-semibold text-foreground">{t('actions.joinCommunity')}</span>
        </a>
      </div>
      ...
      <div className="px-3 pb-3 pt-2 md:hidden">
        ...
        >
          ...
          <span className="text-sm font-semibold text-foreground">{t('actions.settings')}</span>
        </button>
      </div>
    </div>
  );
